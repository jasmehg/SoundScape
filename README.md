...
I also came away knowing a lot more about ocean noise than I expected. The fact that moving a shipping lane by 20 miles can cut whale mortality from noise by over half was genuinely surprising to me. Building the simulation made the scale of the problem feel real in a way that just reading about it didn't. The explained code is in the jupyter notebook.
